...
function update(dt){
  ...
  }else game.player.anim=Math.floor(performance.now()/900)%2?3:4;
...
function drawTitle(){
  ...
  centered('WASD / Arrows • E interact • R rankings • A activities • V rivals • Y yearbook',486,14,COLORS.cream,'bold 14px Trebuchet MS');
  centered('Rivalries & Campus Life edition • Activities • Achievements • v0.7',515,12,COLORS.sky,`12px ${UI_FONT}`);
}
