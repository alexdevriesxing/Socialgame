...
window.addEventListener('keydown',e=>{
  ...
  if(['arrowup','arrowdown','arrowleft','arrowright',' ','e','q','r','j','p','k','a','v','y'].includes(k))e.preventDefault();
  if(game.dialogue){
    if(k===' '||k==='e'||k==='enter'){
  ...
  if(game.overlay){if(k==='escape'||k==='q'||k==='r'||k==='j'||k==='p'||k==='k'||k==='a'||k==='v'||k==='y')game.overlay=null;return;}
  if(game.mode==='play'){
    if(k==='e'||k===' ')interact();
