...
const CHARACTER_SHEET_W = SPRITE_FRAME_W*7;
...
const imageNames = ['keyart','school_maps','portraits','event_atlas','rival_atlas','character_atlas'];
const images = {};
...
const defaultPlayer = () => ({
  ...
  campusActivityLog:[], campusMastery:Object.fromEntries(CAMPUS_ACTIVITIES.map(a=>[a.id,0])), achievements:[], achievementDates:{}, onTimeClasses:0,
