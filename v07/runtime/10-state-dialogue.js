function resetGame(){
  ...
  game.scheduleStatus={};game.dayFlags={talked:[],hotspots:[],help:0,club:0,ontime:0,event:false,brief:false,challenge:false,message:false,showcase:false,activity:false};game.dailyBrief=null;
...
function loadGame(){
  try{
    ...
    game.player.showcaseWins ??= 0; game.player.eventPrestige ??= 0; ensureV7State();
    game.dayFlags ||= {talked:[],hotspots:[],help:0,club:0,ontime:0,event:false,brief:false,challenge:false};
    game.dayFlags.brief ??= false; game.dayFlags.challenge ??= false; game.dayFlags.message ??= false; game.dayFlags.showcase ??= false; game.dayFlags.activity ??= false; game.dailyBrief ||= createDailyBrief(game.year,game.month,game.day,game.player.club);
