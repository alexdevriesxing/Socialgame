...
const CLUB_PROMPTS = {
  athletics:[{text:'Mina needs a strategy for the inter-class relay.',choices:[{text:'Train fast starts.',effects:{fitness:2,score:9},result:'The team launches off the line like arrows.'},{text:'Build team morale.',effects:{charisma:1,kindness:1,score:8},result:'Even the reserves leave practice feeling essential.'},{text:'Chart everyone’s best distance.',effects:{intellect:1,reliability:1,score:8},result:'The lineup finally matches each runner’s strengths.'}]}],
  arts:[{text:'Rina asks you to rescue a festival backdrop that looks “emotionally beige.”',choices:[{text:'Add a dramatic skyline.',effects:{talent:2,score:9},result:'The stage suddenly has depth, light and a destination.'},{text:'Organize a paint team.',effects:{charisma:1,reliability:1,score:8},result:'Five brushes move as one.'},{text:'Interview the actors first.',effects:{kindness:1,talent:1,score:8},result:'The backdrop begins reflecting the story instead of competing with it.'}]}],
  tech:[{text:'Emi’s line-following robot keeps choosing the scenic route.',choices:[{text:'Recalibrate the sensors.',effects:{intellect:2,score:9},result:'The robot discovers straight lines and seems mildly disappointed.'},{text:'Redesign the course markers.',effects:{talent:1,intellect:1,score:8},result:'Better contrast fixes the problem without touching the code.'},{text:'Document every failed attempt.',effects:{reliability:2,score:8},result:'Your notes reveal the exact lighting condition causing the fault.'}]}],
  council:[{text:'Aiko needs a fair way to assign festival stalls.',choices:[{text:'Create a transparent lottery.',effects:{reliability:1,intellect:1,score:9},result:'Even disappointed clubs agree the process was fair.'},{text:'Match stalls to club needs.',effects:{kindness:1,charisma:1,score:8},result:'You prevent the gardening club from being assigned the windowless corner.'},{text:'Host a short mediation session.',effects:{courage:1,charisma:1,score:8},result:'The loudest argument becomes a workable compromise.'}]}]
};
