...
function drawMonthEnd(o){
  ...
  centered(`Chapter ${o.campaign?.chapter||((game.year-1)*12+game.month)} of 48 complete • ${o.campaign?.event||''}`,425,14,COLORS.cream,`bold 14px ${UI_FONT}`);
...
function drawProm(){
  ...
  centered(`Monthly results recorded: ${game.player.monthlyScores.length}`,270,15,COLORS.sky,'bold 15px Trebuchet MS');
