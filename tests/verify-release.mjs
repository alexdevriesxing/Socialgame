...
if (!Array.isArray(manifest.files) || manifest.files.length < 38) throw new Error('Release inventory is incomplete.');
...
if (scripts.length < 29) throw new Error(`Expected at least 29 production scripts; found ${scripts.length}.`);
