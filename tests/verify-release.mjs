...
if (!Array.isArray(manifest.files) || manifest.files.length < 36) throw new Error('Release inventory is incomplete.');
...
if (scripts.length < 27) throw new Error(`Expected at least 27 production scripts; found ${scripts.length}.`);
...
for (const required of ['src/campus.js','src/activity.js','src/visual.js','src/world.js','src/world-polish.js','src/world-title.js','src/commercial-ui.js','src/commercial-campus.js','src/walkable-world.js','src/commercial-world-ui.js','src/accessibility-core.js','src/accessibility-performance.js','src/accessibility-ui.js']) {
