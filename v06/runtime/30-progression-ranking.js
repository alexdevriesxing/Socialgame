...
function nextDay(){
  ...
  game.day++;game.time=470;game.scheduleStatus={};game.dayFlags={talked:[],hotspots:[],help:0,club:0,ontime:0,event:false,brief:false,challenge:false,message:false,showcase:false};game.dailyBrief=null;
...
function continueMonth(){
  ...
  game.player.demerits=Math.max(0,game.player.demerits-1);game.scheduleStatus={};game.dayFlags={talked:[],hotspots:[],help:0,club:0,ontime:0,event:false,brief:false,challenge:false,message:false,showcase:false};game.dailyBrief=null;
...
function socialScore(){
  ...
  return Math.round(100+game.player.score+statScore+friends+club+showcases+trust-game.player.demerits*10-game.player.absences*14-game.player.stress*.5);
}
