...
function drawRelationshipsOverlay(o){
  ...
  addButton(245,466,145,32,'PHONE',openPhone);
  addButton(408,466,145,32,'MEMORIES',()=>game.overlay={type:'memories',title:'Memory Gallery',page:0});
  addButton(571,466,145,32,'CLOSE',()=>game.overlay=null);
}
