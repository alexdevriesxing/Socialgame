...
function drawTitle(){
  ...
  centered('WASD / Arrows • E interact • R rankings • Q schedule • J relationships',486,14,COLORS.cream,'bold 14px Trebuchet MS');
  centered('Festival & Messages edition • Phone stories • Monthly showcases • v0.6',515,12,COLORS.sky,`12px ${UI_FONT}`);
}
